...
4. Enter the following URL: `https://github.com/RiptideNetworking/Riptide.git?path=/Packages/Core#2.2.1`. To install a version other than v2.2.1, replace the `2.2.1` after the `#` with your chosen version number.
