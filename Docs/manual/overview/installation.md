...
4. Enter the following URL: `https://github.com/RiptideNetworking/Riptide.git?path=/Packages/Core#v2.0.0`. To install a version other than v2.0.0, replace the `2.0.0` at the end of the URL with your chosen version number.
