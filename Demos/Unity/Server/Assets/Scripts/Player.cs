...
public class Player : MonoBehaviour
{
    ...
    {
        NetworkManager.Singleton.Server.SendReliable(GetSpawnData(new Message((ushort)ServerToClientId.spawnPlayer)), toClient);
    }
    /// <summary>Sends a player's info to all clients.</summary>
    private void SendSpawn()
    {
        NetworkManager.Singleton.Server.SendReliableToAll(GetSpawnData(new Message((ushort)ServerToClientId.spawnPlayer)));
    }
    ...
    {
        Message message = new Message((ushort)ServerToClientId.playerMovement);
        message.Add(Id);
        message.Add(transform.position);
