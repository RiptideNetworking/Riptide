...
namespace Monogame.Common
{
    public static class MessageExtensionsUnity
    {
        ...
        {
            _ = message.AddFloat(value.X);
            _ = message.AddFloat(value.Y);
            return message;
        }
        ...
        public static Message AddQuaternion(this Message message, Quaternion value) => message.Add(value);
