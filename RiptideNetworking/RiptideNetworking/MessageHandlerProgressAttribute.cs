...
namespace RiptideNetworking
{
    ...
    public sealed class MessageHandlerProgressAttribute : Attribute
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="MessageHandlerProgressAttribute"/> class with the <paramref name="messageId"/> and <paramref name="groupId"/> values.</summary>
        ...
        ///   </para>
        /// </remarks>
        public MessageHandlerProgressAttribute(ushort messageId, byte groupId = 0)
        {
            MessageId = messageId;
            GroupId = groupId;
        }
