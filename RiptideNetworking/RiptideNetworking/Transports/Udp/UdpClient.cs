...
namespace Riptide.Transports.Udp
{
    ...
    public class UdpClient : UdpPeer, IClient
    {
        ...
        /// <inheritdoc/>
        public UdpClient(IPAddress listenAddress = null, SocketMode mode = SocketMode.Both, int socketBufferSize = DefaultSocketBufferSize) : base(listenAddress, mode, socketBufferSize) { }
